        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            ...
            <div className="flex space-x-4">
              <a
                href="https://www.facebook.com/ColumbusFolkMusicSociety/"
                target="_blank"
              ...
              <a
                href="https://www.instagram.com/cfmscolumbus/"
                target="_blank"
                rel="noopener noreferrer"
                className="text-brown hover:text-green transition-colors"
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="https://www.facebook.com/ColumbusFolkMusicSociety/" className="text-brown hover:text-green transition-colors font-body">
                  Facebook
                </Link>
              </li>
              <li>
                <Link href="https://www.instagram.com/cfmscolumbus/" className="text-brown hover:text-green transition-colors font-body">
                  Instagram
                </Link>
              </li>
            </ul>
