        ...
        <div className="min-h-screen bg-bg-brown">
            ...
            <section className="container mx-auto px-4 py-16">
                <div className="mb-12 text-center space-x-4 space-y-4 max-w-3xl mx-auto">
                    ...
                    <a
                        href="/festival/FastFacts_COFF.REV11.1.25FINAL.pdf"
                        className="inline-block px-4 py-2 bg-green text-white font-body font-semibold rounded-lg hover:bg-green/90 transition duration-200"
                        target="_blank"
                        rel="noopener noreferrer"
                    >
                ...
                <div className="max-w-5xl mx-auto space-y-8 bg-white p-8 rounded-lg shadow-lg">
                    <h1 className="text-xl md:text-2xl font-heading font-bold text-charcoal">
                        PRESS RELEASE
                    </h1>
