            ...
            <div className="max-w-4xl mx-auto bg-white p-8 rounded-lg shadow-lg">
                ...
                <ul className="font-body text-gray-700 mb-8 leading-relaxed space-y-2">
                    <li><strong>Email:</strong>
                        <a href="mailto:contact@columbusfolkmusicsociety.org" className="text-brown hover:text-green transition-colors"> CFMS Info</a>
                    </li>
                    <li><strong>Phone:</strong> (555) 123-4567</li>
                    <li><strong>Address:</strong> 123 Folk St, Columbus, OH 43215</li>
                </ul>
